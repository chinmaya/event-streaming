...
public class WordCount {
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		KTable<String, String> counts = stream.flatMapValues(new ValueMapper<String, Iterable<String>>() {
		...
		}).groupByKey().count().mapValues(new ValueMapper<Long, String>() {
		...
		counts.toStream().to(Config.TOPIC_WORD_COUNTS);

		KafkaStreams streams = new KafkaStreams(streamBuilder.build(), Config.streamProperties());
		streams.start();
